    ...
    return (
      <div>
        <Formik
          ...
          onSubmit={(
            values,
            { setSubmitting, setValues, setStatus },
            errors
          ) => {
            const data = values;
            setTimeout(() => {
              this.props.firebase
                ...
                .then(authUser => {
                  ...
                  this.props.firebase.addUserByEmail(
                    authUser.user.uid,
                    values.email
                  );
                })
                ...
                .catch(error => {
                  this.props.snackbar.showMessage(error.message, "error");
                });
            }, 1000);
          }}
          render={props => (
