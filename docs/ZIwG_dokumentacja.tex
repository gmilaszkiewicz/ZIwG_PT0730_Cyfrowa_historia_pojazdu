...
\end{center}
\end{table}
%----------------------HISTORIA NAPRAW SERWISU------------------------------------
\begin{table}[H]
\begin{center}
\captionof{table}{Karta wymagań dla funkcjonalności \textit{Historia napraw serwisu}} 
	\begin{tabular}{|p{0.18\linewidth}|p{0.72\linewidth}|}%{|l|l|}
	\hline
	Id wymagania 	& 15				\\ \hline
	Nazwa			& Historia napraw serwisu \\ \hline
	Opis &Aplikacja powinna umożliwić wyświetlanie historii napraw jakie dokonał serwis
\\ \hline
	Przesłanka & Możliwość zobaczenia historii napraw  \\ \hline
	Ograniczenia i~warunki & Serwis może zobaczyć tylko swoją historię napraw\\ \hline
	Dane wejściowe & Brak \\ \hline
	Wynik &Wyświetlenie historii wykonanych napraw serwisu\\ \hline
	Źródło danych wejściowych &Użytkownik (Serwis samochodowy)\\ \hline
	Przeznaczenie & Serwis samochodowy\\ \hline
	Priorytet & Funkcjonalność rozszerzona \\ \hline
	\end{tabular}
\end{center}
\end{table}
